...
@XmlSeeAlso({
    io.leishvl.core.xml.tdwg.tapir.RequestType.Inventory.Concepts.Concept.class,
    ConceptType.class,
    io.leishvl.core.xml.tdwg.tapir.CapabilitiesResultType.Concepts.Schema.MappedConcept.class
})
