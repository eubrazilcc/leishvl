...
/**
 * Any collection of {@link LeishvlFile}.
 * @author Erik Torres <ertorser@upv.es>
 */
@JsonIgnoreProperties({ "page", "perPage", "query", "sort", "order", "pageFirstEntry", "totalPages" })
public abstract class LeishvlFiles<T extends LeishvlFile> implements Linkable {
	...
	public LeishvlFiles(final String namespace, final Class<T> type, final MongoFilesConfigurer configurer, final Logger logger) {
