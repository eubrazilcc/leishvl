...
package io.leishvl.storage.security;

import static com.google.common.base.MoreObjects.toStringHelper;
import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.collect.Iterables.isEmpty;
import static io.leishvl.storage.security.IdentityProviderHelper.LEISHVL_IDENTITY_PROVIDER;
import static io.leishvl.storage.security.IdentityProviderHelper.defaultIdentityProvider;
import static io.leishvl.storage.security.PermissionHistory.PermissionModificationType.GRANTED;
import static io.leishvl.storage.security.PermissionHistory.PermissionModificationType.REMOVED;
...
import io.leishvl.storage.security.PermissionHistory.PermissionModification;
...
public class User implements Serializable {
	...
	public User() {
		setProvider(LEISHVL_IDENTITY_PROVIDER);
	}
