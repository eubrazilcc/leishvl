...
@XmlSeeAlso({
    io.leishvl.core.xml.tdwg.tapir.CapabilitiesResultType.Operations.Search.OutputModels.KnownOutputModels.OutputModel.class,
    io.leishvl.core.xml.tdwg.tapir.TemplatesCapabilitiesType.Template.class
})
