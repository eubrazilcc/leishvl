...
/**
 * Provides support to store and search file objects. The attributes of this class are derived from the mongoDB files collection, which is part of 
 ...
 */
public abstract class LeishvlBaseFile {
	...
	public boolean equals(final Object obj) {
		if (obj == null || !(obj instanceof LeishvlBaseFile)) {
			return false;
		}
		final LeishvlBaseFile other = LeishvlBaseFile.class.cast(obj);		
