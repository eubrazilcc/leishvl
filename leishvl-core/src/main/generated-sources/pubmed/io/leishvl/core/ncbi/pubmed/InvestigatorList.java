...
public class InvestigatorList {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-11-04T10:30:05+01:00", comments = "JAXB RI v2.2.11")
    public InvestigatorList withInvestigator(Investigator... values) {
        if (values!= null) {
            for (Investigator value: values) {
                getInvestigator().add(value);
            }
        }
        return this;
    }
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2015-11-04T10:30:05+01:00", comments = "JAXB RI v2.2.11")
    public InvestigatorList withInvestigator(Collection<Investigator> values) {
        if (values!= null) {
            getInvestigator().addAll(values);
        }
        return this;
    }
